...
namespace QLTVWF
{
     public partial class Menu : Form
     {
       ...
       (
          ...
          private void DSHVbutton_Click(object sender, EventArgs e)
          {
               ActivateButton(sender);
               OpenChildForm(new DanhSachHocVien());
          }

          private void DSDSbutton_Click(object sender, EventArgs e)
          {
               ActivateButton(sender);
               OpenChildForm(new QuanLyDiemSo());
          }
